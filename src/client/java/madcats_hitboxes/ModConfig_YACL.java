                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Creaking"))
                                        .binding(config.mobsOption.hostile.creaking, () -> config.mobsOption.hostile.creaking, newVal -> config.mobsOption.hostile.creaking = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
